...
// | Desenvolvimento Boleto Bradesco: Edson Junior						            |
// +----------------------------------------------------------------------+
...
$dv = digitoVerificador_barra("$codigobanco$nummoeda$fator_vencimento$valor$agencia$conta_cedente$conta_cedente_dv$nnum$dv_nosso_numero$carteira".'000', 9, 0);
// Numero para o codigo de barras com 44 digitos
$linha = "$codigobanco$nummoeda$dv$fator_vencimento$valor$agencia$conta_cedente$conta_cedente_dv$nnum$dv_nosso_numero$carteira"."000";
