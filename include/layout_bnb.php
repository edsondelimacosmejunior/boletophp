...
// | Desenvolvimento Boleto BNB: Edson Junior						            |
// +----------------------------------------------------------------------+
?>
...
<BR><table cellspacing=0 cellpadding=0 width=666 border=0><tr><td class=cp width=150> 
  <span class="campo"><IMG 
      src="imagens/logobnb.jpg" width="150" height="40" 
      border=0></span></td>
...
</tr><tbody><tr><td colspan=5><img height=2 src=imagens/2.png width=666 border=0></td></tr></tbody></table><table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=ct valign=top width=7 height=17><img height=17 src=imagens/1.png width=1 border=0></td><td class=ct valign=top width=472 height=17>Local 
de pagamento</td><td class=ct valign=top width=7 height=17><img height=17 src=imagens/1.png width=1 border=0></td><td class=ct valign=top width=180 height=17>Vencimento</td></tr><tr><td class=cp valign=top width=7 height=12><img height=22 src=imagens/1.png width=1 border=0></td><td class=cp valign=top width=472 height=22>
                AT&Eacute; O VENCIMENTO PAGUE PREFERENCIALMENTE NO BANCO DO NORDESTE<br/>
                AP&Oacute;S O VENCIMENTO PAGUE SOMENTE NO BANCO DO NORDESTE</td><td class=cp valign=top width=7 height=22><img height=22 src=imagens/1.png width=1 border=0></td><td class=cp valign=top align=right width=180 height=17> 
  <span class="campo">
  <?php echo $dadosboleto["data_vencimento"]?>
  </span></td>
...
<td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td></tr><tr> 
    <td valign=top width=7 height=1><img height=1 src=imagens/2.png width=1 border=0></td></tr></tbody></table></td><td valign=top width=468 rowspan=5><font class=ct>Instru&ccedil;&otilde;es 
        (Todas as Informa&ccedil;&otilde;es deste bloqueto s&atilde;o de EXCLUSIVA responsabilidade do Cedente)</font><br><br><span class=cp> <FONT class=campo>
